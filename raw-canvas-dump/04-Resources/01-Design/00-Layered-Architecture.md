...
* Visit [ChatGPT**Links to an external site.**](https://chat.openai.com/) and use the prompt: `"How do you design software by applying the layered architecture?"`

### 📖 In-Depth Resources

* **Presentation:** [Introduction to the layered architecture](https://fhict.instructure.com/courses/15759/files/2576981?verifier=0FBvkFMYoci0ncmSCKy1U1521GzdHs1DZan6iRIu&wrap=1)
* **Technical Guide:** [Layered Architecture**Links to an external site.**](https://www.baeldung.com/cs/layered-architecture) from Baeldung
* **Advanced Reading:** [The Clean Architecture**Links to an external site.**](https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html) by Uncle Bob Martin
