 ...
 **🧠 Essential Knowledge:** * Basic C# syntax and programming concepts

* Understanding of classes, objects, and methods
* [Object Oriented Principles](https://fhict.instructure.com/courses/15759/pages/object-oriented-principles-2 "Object Oriented Principles")
* Review: [Classes in C#**Links to an external site.**](https://learn.microsoft.com/en-us/dotnet/csharp/fundamentals/tutorials/classes)
* Review: [OOP Principles in C#**Links to an external site.**](https://docs.microsoft.com/en-us/dotnet/csharp/fundamentals/tutorials/oop)

 **📊 UML Preparation:** * Create a simple [class diagram](https://fhict.instructure.com/courses/15759/pages/class-diagram) for a banking application

* Use [draw.io**Links to an external site.**](https://www.drawio.com/blog/uml-class-diagrams) or paper - keep it simple!
* Focus on class names and relationships (associations)

## 💬 Discussion & Questions

Questions about OOP design patterns and best practices?

[💬 Join OOP Discussion](https://fhict.instructure.com/courses/15759/discussion_topics/94071)
 ...
 **🤝 Team Discussion Points:** * **Classes vs Objects:** What's the practical difference in your banking system?
 ...
 **💡 Design Thinking Questions:** * How would you handle insufficient funds for withdrawals?
...
* [SqlCommand Documentation**Links to an external site.**](https://learn.microsoft.com/en-us/dotnet/api/system.data.sqlclient.sqlcommand)
* [SQL Parameters Guide**Links to an external site.**](https://learn.microsoft.com/en-us/dotnet/api/system.data.sqlclient.sqlcommand.parameters)

 **🎯 OOP Integration Guidelines:** * **Encapsulation:** Hide database details from business logic
 ...
 **📊 Update Your Design:** * **Refine your UML diagram** to reflect actual implementation
 ...
 **💡 Reflection Questions:** * Why use SQL parameters instead of string concatenation?
...
**⏭️ Ready for Testing?** Continue with [Acceptance Testing and Unit Testing](https://fhict.instructure.com/courses/15759/pages/acceptance-testing-and-unit-testing) to learn how to validate your OOP design with proper testing strategies.
...
*🧩 OOP Truth: Good object-oriented design isn't about using every feature of OOP - it's about choosing the right abstractions that make your code easier to understand, maintain, and extend.*
