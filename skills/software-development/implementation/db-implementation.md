...
* **Data Types:** VARCHAR vs NVARCHAR, INT vs BIGINT - size matters
...
* **Query Optimization:** Efficient SELECT, JOIN, and WHERE clauses
...
* **Database Design:** A completed ERD from your project or previous workshops
...
* [SQL Server Management Studio (SSMS) tutorial](https://learn.microsoft.com/en-us/sql/ssms/quickstarts/ssms-connect-query-sql-server?view=sql-server-ver16)
* [VS Code with SQL Extension](https://learn.microsoft.com/en-us/sql/tools/visual-studio-code-extensions/mssql/mssql-extension-visual-studio-code?view=sql-server-ver16)
...
1. **Find a Review Partner:** Team up with a peer in your group
2. **Exchange Designs:** Share your database design (ERD) with them
3. **Structured Review:** Give constructive feedback on their design
4. **Discuss Unclear Elements:** Ask questions about confusing relationships or decisions
5. **Refine Your Design:** Incorporate the feedback to improve your design

**💡 Review Questions to Ask:**

* Are all entities properly normalized?
...
1. **Create Database Schema:** Set up your database and tables
2. **Define Constraints:** Primary keys, foreign keys, unique constraints
3. **Add Indexes:** Create indexes for performance-critical columns
4. **Insert Sample Data:** Test your structure with realistic data
5. **Test Relationships:** Verify foreign key constraints work correctly
6. **Write Test Queries:** Ensure your design supports required operations
...
1. **Database Screenshots:** Show your final database structure
2. **Implementation Choices:** Explain why you chose specific data types and constraints
3. **Performance Considerations:** Document your indexing strategy
4. **Challenges & Solutions:** Describe problems you encountered and how you solved them
5. **Future Improvements:** What would you do differently next time?
...
**🔄 Ready for Object-Oriented Programming?** With your database implemented, you're ready to connect it to your application logic. Continue to [OOP in Practice](oop-in-practice.md) to learn how to create the business logic that will interact with your database.
...
*A well-implemented database is invisible to users but essential to developers. It's the foundation that everything else builds on. When your database is solid, your application can be great. When it's flawed, everything that follows struggles. Take the time to get it right.*
